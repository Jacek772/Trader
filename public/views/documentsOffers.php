<?php
    ...
    $_SESSION["location"] = "/documents/offers";
...
<head>
    ...
    <script src="/public/js/documentsOffers.js"></script>
    <title>Trader - Documents offers</title>
</head>
<body>
<div class="container">
    <!-- header -->
    ...
    <main class="user-main">
        ...
        <section class="user-section">
            <div class="user-section-title-container color-darkgray">
                <h1 class="user-section-title">Documents offers</h1>
                <div>
